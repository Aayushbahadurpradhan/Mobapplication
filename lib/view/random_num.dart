...
class _RandomNumberState extends State<RandomNumber> {
  ...
  void _generateRandomNumbers() {
    ...
    do {
      newRandomNumber1 = _random.nextInt(100); // Generate a random number between 0 and 99
  ...
  void _calculateScore(int number1, int number2) {
    ...
    if (number1 > number2) {
      ...
      // Don't decrease the score, but go to the next chance
    }
    ...
    if (_chances == 10) {
      ...
      // Generate new random numbers for the next chance
